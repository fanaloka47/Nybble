...
// Backport of winit upstream commit 488c036a ("win32: disable DPI re-adjustments
// on Windows 11", Fixes #4041). The Windows build number is used to gate winit's
// old DPI re-adjustment workaround to Windows 10 (< 22000); on Windows 11+ the
// OS-suggested rect is trusted verbatim in the WM_DPICHANGED handler.
